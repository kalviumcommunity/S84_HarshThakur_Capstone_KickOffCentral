  ...
  return (
    <div className="dark-landing-root">
        ...
        <section className="dark-hero">
          ...
          <div className="dark-hero-btns">
            <button
              ...
              className="dark-hero-cta animate-scalein"
      ...
      <footer className="dark-footer">
        ...
        <p className="dark-tagline">
          Where Every Project is a Goal, and Every Team is United
        </p>
        <p style={{ fontSize: "0.9rem", opacity: 0.5 }}>
          &copy; {new Date().getFullYear()} KickOff Central
        </p>
      </footer>
    </div>
  );
